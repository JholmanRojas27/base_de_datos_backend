...
def create_app():
    ...
    api = Api(
        ...
        title='API de Gestion hotelera',  # Título para la documentación Swagger
        version='1.0',  # Versión de la API
        description='API para gestión el registro de una reserva en un hotel',  # Descripción de la API
